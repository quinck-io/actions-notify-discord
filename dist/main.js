...
var getJobStatusMessage = (params, statusIcon) => `${statusIcon} Status: *${params.status.toUpperCase()}*
...
var work = async () => {
  ...
  const event = JSON.parse(import_fs.default.readFileSync(input.eventPath, 'utf8'))
